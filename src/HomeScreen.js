...
import { Text, View, StatusBar, StyleSheet, TextInput, TouchableOpacity, Modal, ScrollView, Alert, ToastAndroid } from "react-native";
...
class Home extends Component {
    ...
    handlerReset = () => {
        Alert.alert(null, "Are you sure you want to reset your list?", [{
            text: "Yes", onPress: () => {
                ToastAndroid.showWithGravity("Please Wait...", ToastAndroid.LONG, ToastAndroid.BOTTOM);
        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.headerContainer}>
                    <Text style={styles.headerText}>{this.state.time}, Bima Febriansyah</Text>
                    <TouchableOpacity onPress={() => this.handlerReset()} style={{ ...styles.headerSide, ...styles.headerSideShadow }}>
                    ...
                    <ScrollView>
                        <View style={styles.bodyChild}>
                            <View style={styles.list}>
                                ...
                                <TouchableOpacity>
                                    <Icon style={{ ...styles.listIcon, color: "#ff8b0d" }} name="bolt" />
                                </TouchableOpacity>
                            </View>
                        </View>
                        <View style={styles.bodyChild}>
                            <View style={styles.list}>
                                <Text style={styles.listText}>Makan Seblak Level 20</Text>
                                <TouchableOpacity>
                                    <Icon style={{ ...styles.listIcon, color: "green" }} name="check" />
                                </TouchableOpacity>
                            </View>
                        </View>
                        <View style={styles.bodyChild}>
                            <View style={styles.list}>
                                <Text style={styles.listText}>Makan Seblak Level 20</Text>
                                <TouchableOpacity>
                                    <Icon style={{ ...styles.listIcon, color: "red" }} name="times" />
                                </TouchableOpacity>
                            </View>
                        </View>
                        <TouchableOpacity style={{
                            ...styles.bodyChild, alignContent: "center",
